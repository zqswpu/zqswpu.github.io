<main class="content">
    ...
    <header class="content-hd">
      <section class="info">
        <ul>
          <li>研究方向：计算机视觉、智能图像处理、高性能计算、石油勘探信号处理</li>
          <li>
            ...
            <div class="item">
              ...
              <div class="item-bd">
                  <ul class="section-content">
                    ...
                    <li>2024.01-2025.12&nbsp;&nbsp;&nbsp;地震多次波高效压制与深度学习集成研究，南充市-西南石油大学市校科技战略合作项目（第二负责） &nbsp;</li>
                    <li>2023.01-2024.12&nbsp;&nbsp;&nbsp;激光消光层析水含量成像算法研究，中国空气动力研究与发展中心结冰与防除冰重点实验室开放课题（第一负责） &nbsp;</li>
